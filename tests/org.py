...
class TestOrgs(unittest.TestCase):
	...
	def test_dogear(self):
		...
		self.assertEqual(u"https://vgmdb.net/db/assets/logos-medium/135-1246205463.gif", dogear['picture_small'])
		self.assertEqual(u"https://vgmdb.net/db/assets/logos/135-1246205463.gif", dogear['picture_full'])
