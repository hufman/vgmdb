...
class TestAlbums(unittest.TestCase):
	...
	def test_ff8(self):
		...
		self.assertEqual(u"SME Intermedia Inc.", ff8['distributor']['names']['en'])
		self.assertEqual(u"org/186", ff8['distributor']['link'])
		self.assertEqual(u"SME Intermedia Inc.", ff8['organizations'][1]['names']['en'])
	...
	def test_million(self):
		...
		self.assertEqual(u"VISUAL ARTS Co., Ltd.", million['organizations'][1]['names']['en'])
		...
		self.assertEqual(u"VISUAL ARTS Co., Ltd.", million['organizations'][2]['names']['en'])
		self.assertEqual(u'株式会社ビジュアルアーツ', million['organizations'][2]['names']['ja'])
